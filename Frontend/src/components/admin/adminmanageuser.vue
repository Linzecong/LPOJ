<template>
  <el-form :model="form">
    ...
    <el-table :data="tableData" size="small">
      ...
      <el-table-column prop="course" label="专业"></el-table-column>
      ...
      <el-table-column prop="type" label="权限" width="50"></el-table-column>
      <el-table-column prop="regtime" label="注册时间"></el-table-column>
      <el-table-column fixed="right" label="操作" width="160">
        <template slot-scope="scope">
          <el-button @click="userclick(scope.row)" type="primary" size="small">编辑</el-button>
          <el-button @click="gouser(scope.row)" type="primary" size="small">查看</el-button>
        </template>
      </el-table-column>
    </el-table>

    <el-dialog title="登录记录" :visible.sync="dialogDataVisible" width="75%">
      <el-input
      ...
      <el-table :data="tableData2" size="mini">
        ...
        <el-table-column prop="msg" label="其他信息"></el-table-column>
      </el-table>
    </el-dialog>

    <el-dialog title="修改用户信息" :visible.sync="dialogDataVisible2" width="85%">
      <el-row :gutter="10" style="margin-top:30px;">
        ...
        <el-button type="success" @click="checklogin" style="margin-left:20px;">查询登录记录</el-button>
      </el-row>
      ...
      <el-row :gutter="10">
        ...
        <el-col :span="12">
          <el-input type="password" v-model="password" autocomplete="off" placeholder="不修改密码则留空"></el-input>
        </el-col>
      </el-row>
      <el-row :gutter="10">
        <el-col :span="3">
        ...
        <el-col :span="12">
          <el-input type="password" v-model="comfirm" autocomplete="off" placeholder="不修改密码则留空"></el-input>
        </el-col>
      </el-row>
      <el-row :gutter="10">
        <el-col :span="3">
      ...
      <el-row :gutter="10">
        ...
        <el-col :span="12">
          <el-select v-model="form.type" placeholder="选择权限...">
            <el-option key="普通" label="普通" :value="1"></el-option>
            <el-option key="管理员" label="管理员" :value="2"></el-option>
            <el-option key="超级管理员" label="超级管理员" :value="3"></el-option>
          </el-select>
        </el-col>
        <el-button type="success" @click="updateClick" style="float:right;margin-right:10px;">更新</el-button>
      </el-row>
    </el-dialog>
  </el-form>
</template>
