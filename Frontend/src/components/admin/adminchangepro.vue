      ...
      <el-form ref="problemform" :model="problemform" label-position="right" v-loading="loading">
        <el-form-item label="题目编号：">
          <el-input
            ...
            readonly
          >
            <el-button slot="append" icon="el-icon-search" @click="problemchange"></el-button>
          </el-input>
        </el-form-item>

        <el-form-item label="特殊选项：添加其他OJ题目用！不知道的话请忽略">
          <el-input v-model="problemform.oj" placeholder="OJ" style="width:100px;"></el-input>
          <el-input
