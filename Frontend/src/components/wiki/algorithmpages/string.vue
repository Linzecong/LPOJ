<template>
  <div>
    <el-row>
      <el-col :span="4">
        <el-menu default-active="string_index" @select="handleSelect">
          <el-menu-item index="string_index">字符串简介</el-menu-item>
          <el-menu-item index="string_libfunc">标准库函数</el-menu-item>
          <el-menu-item index="string_match">字符串匹配</el-menu-item>
          <el-menu-item index="string_hash">哈希</el-menu-item>
          <el-menu-item index="string_prefixfunction">前缀函数与 KMP 算法</el-menu-item>
          <el-menu-item index="string_trie">字典树 (Trie)</el-menu-item>
          <el-menu-item index="string_pam">回文自动机</el-menu-item>
          <el-menu-item index="string_sa">后缀数组 (SA)</el-menu-item>
          <el-menu-item index="string_acautomaton">AC 自动机</el-menu-item>
          <el-menu-item index="string_sam">后缀自动机 (SAM)</el-menu-item>
          <el-menu-item index="string_suffixtree">后缀树</el-menu-item>
